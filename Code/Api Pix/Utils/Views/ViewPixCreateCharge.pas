...
type
  TViewPixCreateCharge = class(TForm)
    GroupBox3: TGroupBox;
    txtIdent: TEdit;
    Label1: TLabel;
    gbDevedor: TGroupBox;
...
procedure TViewPixCreateCharge.btnCancelRequestClick(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

procedure TViewPixCreateCharge.btnConfirmRequestClick(Sender: TObject);
begin
...
procedure TViewPixCreateCharge.FormCreate(Sender: TObject);
begin
  Self.Position := poScreenCenter;
end;

function TViewPixCreateCharge.GetIdent: String;
begin
  Result := txtIdent.Text;
end;

function TViewPixCreateCharge.GetBody: String;
var
...
procedure TViewPixCreateCharge.ClearRequestfields;
begin
